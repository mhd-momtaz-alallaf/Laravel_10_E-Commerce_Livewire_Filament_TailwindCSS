                    ...
                    <div class="px-3 mb-4">
                        <div class="items-center justify-between hidden px-3 py-2 bg-gray-100 md:flex dark:bg-gray-900 ">
                            <div class="flex items-center justify-between">
                                {{-- Sorting Options --}}
                                <select wire:model.live="sort_by" id="" class="block w-40 text-base bg-gray-100 cursor-pointer dark:text-gray-400 dark:bg-gray-900">
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        {{-- creating a livewire adding the product to the cart event by the method addToCart() from the component class --}} {{-- we used .prevent to prevent the page from reloading after clicking the 'Add to Cart' button --}}
