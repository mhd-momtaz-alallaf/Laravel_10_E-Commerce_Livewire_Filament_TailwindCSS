...
<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
	...
	<form wire:submit.prevent="placeOrder"> {{-- preventing submiting the form and performing the 'placeOrder' method instead from the component --}}
		<div class="grid grid-cols-12 gap-4">
			...
			<div class="md:col-span-12 lg:col-span-8 col-span-12">
				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						<li>
							<input wire:model="payment_method" value="cod" class="hidden peer" id="cod_payment_method" required="" type="radio" />

							<label class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 @error('payment_method') border-red-500 @enderror rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700" for="cod_payment_method">
								<div class="block">
								...
								<svg aria-hidden="true" class="w-5 h-5 ms-3 rtl:rotate-180" fill="none" viewbox="0 0 14 10" xmlns="http://www.w3.org/2000/svg">
									<path 
										d="M1 5h12m0 0L9 1m4 4L9 9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
									</path>
								</svg>
							</label>
						</li>
						...
						<li>
							<input wire:model="payment_method" value="stripe" class="hidden peer" id="stripe_payment_method" type="radio"/>

							<label class="inline-flex items-center justify-between w-full p-5 text-gray-500 bg-white border border-gray-200 @error('payment_method') border-red-500 @enderror rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700" for="stripe_payment_method">
								<div class="block">
									<div class="w-full text-lg font-semibold">
										Stripe
									</div>
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				...
				<button type="submit" class="bg-green-500 mt-4 w-full p-3 rounded-lg text-lg text-white hover:bg-green-600">
					...
					{{-- Adding a Processing... Loader when the user clicks the Button --}}
